...
#ifndef ARM_LINKING_H_
#define ARM_LINKING_H_
...
template <size_t DOF>
class MasterMaster : public systems::System {
...
public:
	...
	System(sysName),JpInput(this),JpHandTool(this),JpOutput(this,&jpOutputValue), sock(-1), linked(false), numMissed(NUM_MISSED_LIMIT), theirJp(0.0)
	{
        ...
        joint_pos_sub = n_.subscribe(remoteHost, 1, &MasterMaster::joint_pos_cb, this);
